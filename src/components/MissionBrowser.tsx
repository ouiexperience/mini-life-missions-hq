    ...
    <div className="mb-8">
      <div className="flex flex-col gap-4 mb-6">
        ...
        <div className="flex flex-col gap-2">
          <h2 className="text-2xl font-bold text-primary mb-2">Categories</h2>
          <div className="flex flex-wrap gap-2">
            ...
            <Button 
              variant={selectedCategory === "Money Smart" ? "default" : "outline"} 
              size="sm"
              className={selectedCategory === "Money Smart" ? "bg-mission-money text-white" : ""}
              onClick={() => handleCategoryFilter("Money Smart")}
            >
              Money Smart
            </Button>
            <Button 
              variant={selectedCategory === "Healthy Habits" ? "default" : "outline"} 
              size="sm"
              className={selectedCategory === "Healthy Habits" ? "bg-mission-health text-white" : ""}
              onClick={() => handleCategoryFilter("Healthy Habits")}
            >
              Healthy Habits
            </Button>
            <Button 
              variant={selectedCategory === "Confidence & Connection" ? "default" : "outline"} 
              size="sm"
              className={selectedCategory === "Confidence & Connection" ? "bg-mission-communication text-white" : ""}
              onClick={() => handleCategoryFilter("Confidence & Connection")}
            >
