...
const WelcomeSection: React.FC = () => {
  return (
    <section className="text-center py-8 px-4 mb-8 fade-in">
      <h1 className="text-3xl md:text-4xl font-bold text-primary mb-2">Welcome to Mini Life Missions!</h1>
      <p className="text-lg mb-8 text-foreground/80">Choose how you want to teach today:</p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        <Card className="p-6 hover:shadow-md transition-shadow border-2 border-primary/20 hover:border-primary/40">
          <Link to="/pick-and-learn" className="block h-full">
            <div className="flex flex-col h-full">
              <h3 className="text-xl font-bold mb-3 text-primary">Pick &amp; Learn</h3>
        ...
        <Card className="p-6 hover:shadow-md transition-shadow border-2 border-secondary/20 hover:border-secondary/40">
          <Link to="/turn-it-around" className="block h-full">
            <div className="flex flex-col h-full">
              <h3 className="text-xl font-bold mb-3 text-secondary">Turn It Around Moments</h3>
